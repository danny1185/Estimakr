...
<head>
 ...
 <link href="https://fonts.googleapis.com/css?family=Lora&display=swap" rel="stylesheet">
  ...
  <link rel="stylesheet" text="text/css" href="./css/navbar.css">
...
<center>
    ...
    {
        echo '<div class="bg-danger">'.$_SESSION['error'].'</div>';
    }
    ?>
    <br>
    <form action="<?php echo BASE_URL?>controllers/login.php" method="post" class="formstyle col-md-8 col-lg-6 mr-auto ml-auto">
  <div class="form-group">
      <h2 align="center" class="bg-primary z-depth-2" id="signInFormHeader">Login</h2> <br>
  ...
  <div class="form-group">
    ...
    <input type="password" name="password" class="form-control z-depth-1" id="exampleInputPassword1" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
  </div>
